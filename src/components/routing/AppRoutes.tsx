...
const SenderDashboard = lazy(() => import("@/pages/dashboard/SenderDashboard"));
const DriverDashboard = lazy(() => import("@/pages/dashboard/DriverDashboard"));
const CommunityManagerDashboard = lazy(() => import("@/pages/dashboard/CommunityManagerDashboard"));
const Profile = lazy(() => import("@/pages/Profile"));
const CompleteProfile = lazy(() => import("@/pages/CompleteProfile"));

// Order and transport pages
const Orders = lazy(() => import("@/pages/Orders"));
const OrderDrafts = lazy(() => import("@/pages/orders/OrderDrafts"));
const OrderDraftEdit = lazy(() => import("@/pages/orders/OrderDraftEdit"));
...
// Dev/Test Pages
const InvoiceTest = lazy(() => import("@/pages/dev/InvoiceTest"));
const EmailTest = lazy(() => import("@/pages/dev/EmailTest"));
const RlsTest = lazy(() => import("@/pages/dev/RlsTest"));
